...
public class MainActivity extends FlutterActivity {
  ...
  private static final String BLUETOOTH_CHANNEL="cmmp/bluetooth";   // 蓝牙channel
  private static final String COMMUNICATION_CHANNEL="cmmp/communication";         // 通信channel
